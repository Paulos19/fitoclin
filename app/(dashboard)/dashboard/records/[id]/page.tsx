...
export default async function RecordDetailPage({ params }: Props) {
  ...
  // 1. Verificação de Acesso (Adicionado SECRETARY)
  ...
  // 3. Verificação de Propriedade (Segurança para Profissionais)
  // Profissional só pode ver SEUS pacientes. Admin e Secretária veem todos.
          ...
          <div className="grid md:grid-cols-3 gap-6 h-full">
            <div className="md:col-span-2">
              <PrescriptionPanel
                ...
                // Dados Injetados para o componente
