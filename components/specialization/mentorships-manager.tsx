                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={sourceType} onValueChange={(v: any) => setSourceType(v)}>
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="UPLOAD">Upload Direto (Máx 256MB)</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            ...
                            {sourceType === "YOUTUBE" ? (
                                ...
                                <div className="space-y-2 animate-in fade-in">
                                    ...
                                    <Alert variant="destructive" className="mt-2 bg-yellow-500/10 border-yellow-500/50 text-yellow-600 dark:text-yellow-400">
                                        ...
                                        <AlertDescription>
                                            O upload direto agora tem limite de <strong>256MB</strong> através do UploadThing.
                                            Para mentorias extremamente longas que excedam isso, use a opção YouTube.
                                        </AlertDescription>
                                    </Alert>
                                </div>
                            )}
